...
contract SafeMoon is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, uint8 decimals_, uint256 taxFee_, uint256 liqFee_, uint256 totalSupply_, uint256 initialLiquidity_, uint256 maxTx_, address uniV2RouterAddress_) public {
        _name = name_;
        _symbol = symbol_;
        _decimals = decimals_;
        _taxFee = taxFee_;
        ...
        numTokensSellToAddToLiquidity = initialLiquidity_.mul(10**6).mul(10**uint256(decimals_));
